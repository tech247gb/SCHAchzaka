...
/* harmony import */ var _services_global_login_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../services/global/login.service */ "./src/app/services/global/login.service.ts");
...
/* harmony import */ var src_app_services_equipment_equipment_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/equipment/equipment.service */ "./src/app/services/equipment/equipment.service.ts");
/* harmony import */ var src_app_services_equipmentX2_equipmentX2_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/equipmentX2/equipmentX2.service */ "./src/app/services/equipmentX2/equipmentX2.service.ts");
/* harmony import */ var src_app_services_equipmentX3_equipmentX3_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/services/equipmentX3/equipmentX3.service */ "./src/app/services/equipmentX3/equipmentX3.service.ts");
...
let LoginPage = class LoginPage {
    constructor(router, homeService, equiService, equiX2Service, equiX3Service, loginService, settingsService) {
        this.router = router;
    ...
    onSubmit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const user = yield this.loginService.getUser(this.user);
            localStorage.empNum = this.user.number;
            if (user) {
                localStorage.user = JSON.stringify(user);
                let dateFrom = "2000-01-01";
                let dateTo = moment__WEBPACK_IMPORTED_MODULE_9__().add(30, "d").format("YYYY-MM-DD");
                ;
                ...
                localStorage.taskLength = yield this.equiService.getTaskX1Count();
                localStorage.taskX2Length = yield this.equiX2Service.getTaskX2Count();
                localStorage.taskX3Length = yield this.equiX3Service.getTaskX3Count();
...
LoginPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
        ...
        src_app_services_equipment_equipment_service__WEBPACK_IMPORTED_MODULE_6__["EquipmentService"],
        src_app_services_equipmentX2_equipmentX2_service__WEBPACK_IMPORTED_MODULE_7__["EquipmentX2Service"],
        src_app_services_equipmentX3_equipmentX3_service__WEBPACK_IMPORTED_MODULE_8__["EquipmentX3Service"],
        _services_global_login_service__WEBPACK_IMPORTED_MODULE_2__["LoginService"],

...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _checklist_crud__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checklist.crud */ "./src/app/services/checklist/checklist.crud.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let ChecklistService = class ChecklistService {
    constructor(equipmenrService, syncAPIService, utils) {
        ...
        this.getCL = (equipment) => {
            console.log('equipment', equipment);
            this.webDb = this.syncAPIService.webDb;
            try {
                return new Promise((resolve, reject) => {
                    this.webDb.transaction((tx) => {
                        tx.executeSql("SELECT * FROM checklist WHERE equipment = ?", [equipment], (tx, results) => {
...
ChecklistService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_checklist_crud__WEBPACK_IMPORTED_MODULE_1__["ChecklistCrudService"], _sync_service__WEBPACK_IMPORTED_MODULE_3__["SyncAPIService"], _global_utils_service__WEBPACK_IMPORTED_MODULE_4__["UtilsService"]])
], ChecklistService);
...
/* harmony import */ var _setting_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./setting.service */ "./src/app/services/global/setting.service.ts");
/* harmony import */ var _checklist_checklist_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../checklist/checklist.service */ "./src/app/services/checklist/checklist.service.ts");
...
let TreatmentsService = class TreatmentsService {
    constructor(loadingCtrl, http, checkListService, setting) {
    ...
    setTreatment(Treatment) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let loading = yield this.loadingCtrl.create({ message: "...שולח טיפול" });
            loading.present();
            try {
                return new Promise((resolve, reject) => {
                    this.http
...
TreatmentsService.ctorParameters = () => [
...
TreatmentsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: "root",
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"],
        _checklist_checklist_service__WEBPACK_IMPORTED_MODULE_5__["ChecklistService"],
        _setting_service__WEBPACK_IMPORTED_MODULE_4__["SettingsService"]])
], TreatmentsService);
...
//# sourceMappingURL=default~pages-home-home-module~pages-task-page-task-page-module~pages-tipulim-tipulim-module-es2015.js.map